...
# C
gcc -O3 -march=native -lm -o code_serial_exe code.c        #Serial code
gcc -O3 -march=native -lm -fopenmp -o code_exe code.c      #OpenMP aware code
\end{verbatim}
...
# C
icc -O3 -xHost -o code_serial_exe  code.c         #Serial code
icc -qopenmp -O3 -xHost -o code_exe  code.c       #OpenMP aware code
\end{verbatim}
